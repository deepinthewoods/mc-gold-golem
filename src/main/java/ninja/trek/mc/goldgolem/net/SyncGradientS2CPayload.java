...
public record SyncGradientS2CPayload(int entityId, int width, int window, List<String> blocks) implements CustomPayload {
    ...
    public static final PacketCodec<RegistryByteBuf, SyncGradientS2CPayload> CODEC = PacketCodec.tuple(
            ...
            PacketCodecs.VAR_INT, SyncGradientS2CPayload::window,
